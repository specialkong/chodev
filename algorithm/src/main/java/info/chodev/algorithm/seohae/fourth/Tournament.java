...
다음 라운드에선 다시 참가자의 번호를 1번부터 매긴다. 이 때, 번호를 매기는 순서는 처음 번호의 순서를 유지하면서 1번부터 매긴다. 
...
public class Tournament {
	 ...
	 * @return
	 */
	public int numFind(int num, int jimin, int hansu){
		int answer = 0;
		int result = num / 2; //8
	...
	public static void main(String[] args) {
		...
		System.out.println(tournament.numFind(16,8,9));
	}
}
