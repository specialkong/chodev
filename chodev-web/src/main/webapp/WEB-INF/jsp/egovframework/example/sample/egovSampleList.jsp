<%@include file="/WEB-INF/jsp/chodev/include/taglib.jsp"%>
...
<head>
	...
	<%@include file="/WEB-INF/jsp/chodev/include/commonResource.jsp"%>
    ...
    $(function(){
        ...
        $("#btnOK").click(function(){  
            ...
            var url = "/ajaxSample.do";  
            var params = {id:7, name:"tester"};  
            ...
            $.ajax({      
                ...
                success:function(result){   
                    $("#printAjax").html(JSON.stringify(result));      
                },   
                error:function(e){  
        	...
        	<div id="sysbtn">
        	  <ul>
        	      <li>
					...
					<li>
						<span class="btn_blue_l">
							<a id="btnOK" href="#">ajax call</a>
					 		<img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
						</span>
                  </li>
                  <li>
						<span class="btn_blue_l">
							<a id="clear" href="#">ajax clear</a>
					 		<img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
						</span>
                  </li>
              </ul>
